 ...
 * @since 1.0.0
 */
class BookingTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_ra_treasurer.booking';
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_ra_treasurer.booking.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_ra_treasurer/access.xml',
				"/access/section[@name='booking']/"
			);
			$default_actions = Access::getAssetRules('com_ra_treasurer.booking.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetParentId($table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_ra_treasurer');

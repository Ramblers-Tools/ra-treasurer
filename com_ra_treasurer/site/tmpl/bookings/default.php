...
<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post"
	...
	<div class="table-responsive">
		<table class="table table-striped" id="bookingList">
			...
			<tr>
					...
					<th class=''>
						<?php echo HTMLHelper::_('grid.sort',  'COM_RA_TREASURER_BOOKINGS_ID', 'a.id', $listDirn, $listOrder); ?>
					</th>
					...
					<th class=''>
						<?php echo HTMLHelper::_('grid.sort',  'COM_RA_TREASURER_BOOKINGS_EVENT_DATE', 'a.event_date', $listDirn, $listOrder); ?>
					</th>

					<th class=''>
						<?php echo HTMLHelper::_('grid.sort',  'COM_RA_TREASURER_BOOKINGS_EVENT_NAME', 'a.event_name', $listDirn, $listOrder); ?>
					</th>

					<th class=''>
						<?php echo HTMLHelper::_('grid.sort',  'COM_RA_TREASURER_BOOKINGS_MEMBER_NAME', 'a.member_name', $listDirn, $listOrder); ?>
					</th>

					<th class=''>
						<?php echo HTMLHelper::_('grid.sort',  'COM_RA_TREASURER_BOOKINGS_AMOUNT_DUE', 'a.amount_due', $listDirn, $listOrder); ?>
					</th>
	...
	<?php if ($canCreate) : ?>
		<a href="<?php echo Route::_('index.php?option=com_ra_treasurer&task=bookingform.edit&id=0', false, 0); ?>"
